...
public class WeatherHttpClient(HttpClient httpClient) : IWeatherHttpClient
{
    ...
    public async Task<WeatherApiResponseDTO?> FetchHistoricalWeatherDataAsync(string stationId, string formatedDate)
    {
    ...
    public async Task<WeatherApiResponseDTO?> FetchCurrentDayWeatherDataAsync(string stationId)
    {
