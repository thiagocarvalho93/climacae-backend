...
public interface IObservationRepository
{
    ...
    Task<IEnumerable<StationStatisticDTO>> GetStatistics(DateTime initialDate, DateTime finalDate, string timePeriod, string stationId, CancellationToken token = default);
